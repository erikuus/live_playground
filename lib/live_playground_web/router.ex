defmodule LivePlaygroundWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {LivePlaygroundWeb.Layouts, :root}
  ...
  scope "/", LivePlaygroundWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{LivePlaygroundWeb.UserAuth, :require_authenticated}] do
  ...
  scope "/", LivePlaygroundWeb do
    ...
    live_session :current_user,
      on_mount: [{LivePlaygroundWeb.UserAuth, :mount_current_scope}] do
